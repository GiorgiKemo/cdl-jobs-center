    ...
    <section className="relative overflow-hidden bg-secondary min-h-[90vh] flex items-center">
      ...
      <div className="container mx-auto relative z-10 py-20">
        <div className="max-w-2xl">
          ...
          >
            Apply once, get matched with top carriers instantly.
            Over 2,000 drivers placed and counting.
          </motion.p>
          ...
          >
            <Button size="lg" className="text-lg px-8 glow-orange group" asChild>
              <Link to="/apply">
                Apply Now
                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="text-lg px-8 border-border/50 text-secondary-foreground hover:bg-muted/20" asChild>
          ...
          <motion.div
            ...
            className="flex items-center gap-8 mt-12 pt-8 border-t border-border/20"
          >
